  ...
  return (
    <>
      <header className="module-header">
        ...
        <button type="button" className="primary-button" onClick={() => setCreatorOpen(true)}><AdminIcon name="add" /> Crear evento</button>
      </header>
      <EventCreator
        open={creatorOpen}
              ...
              <article className="catalog-card" key={event.id}>
                ...
                <div className="catalog-main">
                  ...
                  <div className="catalog-meta">
                    <span><AdminIcon name="clock" /> {new Intl.DateTimeFormat("es-CO", { hour: "numeric", minute: "2-digit", timeZone: PLATFORM_TIMEZONE }).format(start)}</span>
